---
description: 更新 vasmc-expert 技能（重新生成知识手册并重编译）
---

# 更新 vasmc-expert 技能

当 VASMC 的 DESIGN 或 HELP 文档发生变更后，执行此流程以保持 `vasmc-expert` 技能与最新文档同步。
...
4. 重新编译 `vasmc-expert` 技能（将新的知识手册内联进最终技能文件）：
// turbo
```bash
...
完成后，`skills/vasm-expert/SKILL.md` 即为最新的自包含技能文件。
