...
2. [AI 工作流](AI-WORKFLOW.vasm.md)：说明 AI 编辑器如何读取 `.vasmc/build-report.yaml`，执行 verify、translate、tree-shake、policy 和 project review。
3. [协议参考](REFERENCE.vasm.md)：完整列出 manifest、import、语言块、build config、report actions 和 policy diagnostics。
