...
2. [AI Workflow](AI-WORKFLOW.md): explains how AI editors should read `.vasmc/build-report.yaml` and execute verify, translate, refresh-translation, tree-shake, policy, and project review actions.
...
2. [AI 工作流](AI-WORKFLOW.md)：说明 AI 编辑器如何读取 `.vasmc/build-report.yaml`，执行 verify、translate、refresh\_translation、tree-shake、policy 和 project review。
